...
class DlgAddRectangle(tk.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)
        self.parent = parent
        self.title("Add Rectangle")
        self.output_color: str = "Color"
        ...
        self.label_object_x = tk.Label(self, text="Object X:", anchor="w")
        self.label_object_x.grid(row=0, column=0)

        self.var_object_x_qty = tk.DoubleVar(value=1.0)
        self.entry_object_x = ttk.Entry(self, textvariable=self.var_object_x_qty, width=5)
        self.entry_object_x.grid(row=0, column=1)

        self.label_object_y = tk.Label(self, text="Object Y:", anchor="w")
        self.label_object_y.grid(row=1, column=0)

        self.var_object_y_qty = tk.DoubleVar(value=1.0)
        self.entry_object_y = ttk.Entry(self, textvariable=self.var_object_y_qty, width=5)
        self.entry_object_y.grid(row=1, column=1)

        self.label_object_z_floor = tk.Label(self, text="Object Z Floor:", anchor="w")
        self.label_object_z_floor.grid(row=2, column=0)
        ...
        self.entry_object_z_floor.grid(row=2, column=1)

        self.label_object_z_ceiling = tk.Label(self, text="Object Z Ceiling:", anchor="w")
        self.label_object_z_ceiling.grid(row=3, column=0)
        ...
        self.entry_object_z_ceiling.grid(row=3, column=1)

        self.label_object_starting_x = tk.Label(self, text="Object Starting X:", anchor="w")
        self.label_object_starting_x.grid(row=4, column=0)
        ...
        self.entry_object_starting_x.grid(row=4, column=1)

        self.label_object_starting_y = tk.Label(self, text="Object Starting Y:", anchor="w")
        self.label_object_starting_y.grid(row=5, column=0)
        ...
        self.entry_object_starting_y.grid(row=5, column=1)
