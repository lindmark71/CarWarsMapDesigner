...
class DlgAddText(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.label_text = tk.Label(self, text="Text:", anchor="w")
        self.label_text.grid(row=0, column=0, sticky="w")

        self.var_text = tk.StringVar(value="")
        self.entry_text = ttk.Entry(self, textvariable=self.var_text, width=50)
        self.entry_text.grid(row=1, column=0, sticky="w", columnspan=2)

        self.label_object_starting_x = tk.Label(self, text="Object Starting X:", anchor="w")
        self.label_object_starting_x.grid(row=2, column=0)
        ...
        self.entry_object_starting_x.grid(row=2, column=1)

        self.label_object_starting_y = tk.Label(self, text="Object Starting Y:", anchor="w")
        self.label_object_starting_y.grid(row=3, column=0)
        ...
        self.entry_object_starting_y.grid(row=3, column=1)
        ...
        self.color_dropdown.grid(row=4, column=0)
